...
#data<-subset(data, select = -c(ER.Status))
```
...
The most important variable is shown to be the first split in our decision tree, the converted stage. In order of descending importance are the days to date of last contact, ACJCC Stage (only if they are stages IB, III, IIIC, or IV), age at initial pathologic diagnosis, and the rest of the AJCC Stages.
